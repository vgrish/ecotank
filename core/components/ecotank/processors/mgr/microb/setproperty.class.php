...
/**
 * SetProperty a ecotankMicrob
 */
class modecotankMicrobSetPropertyProcessor extends modObjectUpdateProcessor
{
	/** @var ecotankMicrob $object */
	public $object;
...
return 'modecotankMicrobSetPropertyProcessor';