...
/**
 * SetProperty a ecotankUniTank
 */
class modecotankUniTankSetPropertyProcessor extends modObjectUpdateProcessor
{
	/** @var ecotankUniTank $object */
	public $object;
...
return 'modecotankUniTankSetPropertyProcessor';