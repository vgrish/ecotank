ecotank.window.CreateResson = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        title: _('create'),
        width: 650,
    ...
    ecotank.window.CreateResson.superclass.constructor.call(this, config);
};
Ext.extend(ecotank.window.CreateResson, MODx.Window, {
...
Ext.reg('ecotank-window-kesson-create', ecotank.window.CreateResson);
