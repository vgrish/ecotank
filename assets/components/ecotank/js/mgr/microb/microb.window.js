ecotank.window.CreateMicrob = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        title: _('create'),
        width: 650,
    ...
    ecotank.window.CreateMicrob.superclass.constructor.call(this, config);
};
Ext.extend(ecotank.window.CreateMicrob, MODx.Window, {
...
Ext.reg('ecotank-window-microb-create', ecotank.window.CreateMicrob);
