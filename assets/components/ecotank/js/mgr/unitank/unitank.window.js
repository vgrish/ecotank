ecotank.window.CreateUniTank = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        title: _('create'),
        width: 650,
    ...
    ecotank.window.CreateUniTank.superclass.constructor.call(this, config);
};
Ext.extend(ecotank.window.CreateUniTank, MODx.Window, {
...
Ext.reg('ecotank-window-unitank-create', ecotank.window.CreateUniTank);
