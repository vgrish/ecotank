ecotank.window.CreateTank = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        title: _('create'),
        width: 650,
    ...
    ecotank.window.CreateTank.superclass.constructor.call(this, config);
};
Ext.extend(ecotank.window.CreateTank, MODx.Window, {
...
Ext.reg('ecotank-window-tank-create', ecotank.window.CreateTank);
