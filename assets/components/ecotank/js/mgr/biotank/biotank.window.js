ecotank.window.CreateBioTank = function (config) {
    config = config || {};
    if (!config.class) {
        config.class = 'ecotankBioTank';
    }
    Ext.applyIf(config, {
        title: _('create'),
        width: 650,
    ...
    ecotank.window.CreateBioTank.superclass.constructor.call(this, config);
};
Ext.extend(ecotank.window.CreateBioTank, MODx.Window, {
...
Ext.reg('ecotank-window-biotank-create', ecotank.window.CreateBioTank);
